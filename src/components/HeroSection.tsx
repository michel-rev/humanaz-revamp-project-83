      ...
      <div className="relative container mx-auto px-4 sm:px-6 pt-28 sm:pt-24 pb-40 sm:pb-40 lg:pb-48">
        <div className="flex flex-col-reverse lg:flex-row items-center justify-between min-h-screen">
          ...
          <div className="lg:w-1/2 text-white space-y-4 animate-fade-in order-2 lg:order-1">
            ...
            <h1 className="text-hero-mobile font-bold leading-tight">
              Seu{" "}
            ...
            <div className="text-body-mobile text-slate-300 leading-relaxed max-w-2xl">
            ...
            <div className="flex flex-col gap-4 sm:flex-row sm:gap-4">
              <a href="#investimento" className="w-full sm:w-auto">
                <Button size="lg" className="w-full bg-gradient-to-r from-purple-600 to-pink-600 hover:from-purple-700 hover:to-pink-700 text-white border-0 text-button-mobile px-8">
                  Começar Agora
                  <ArrowRight className="ml-2 h-5 w-5" />
                </Button>
              </a>
              
              <Button size="lg" variant="gradient-outline" className="w-full sm:w-auto text-button-mobile px-8">
