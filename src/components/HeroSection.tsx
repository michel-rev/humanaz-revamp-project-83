      ...
      <div className="relative container mx-auto px-4 pt-8 pb-32">
        <div className="flex flex-col-reverse lg:flex-row items-center justify-between min-h-screen">
          ...
          <div className="lg:w-1/2 text-white space-y-4 animate-fade-in order-2 lg:order-1">
            ...
            <h1 className="text-2xl sm:text-3xl md:text-[3.45rem] md:leading-[3.8rem] font-bold leading-tight">
              Seu{" "}
            ...
            <div className="text-lg sm:text-xl text-slate-300 leading-relaxed max-w-2xl space-y-2">
              ...
              <p>• Reduzimos custo de preenchimento de vagas e aumentamos a retenção junto ao time de engenharia de software?</p>
            </div>
