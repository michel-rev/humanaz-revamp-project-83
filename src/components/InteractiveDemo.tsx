      ...
      <div className="container mx-auto px-4 relative">
        <div className="text-center mb-12 sm:mb-16">
          ...
          <p className="text-lg sm:text-xl text-slate-300 max-w-4xl mx-auto leading-relaxed px-4">
            Vamos além da vaga. Um processo inteligente que conecta vivências e experiências do profissional em resolver problemas reais de negócio, com a atitude que o crescimento da sua empresa precisa e contextual.
          </p>
        </div>

        {/* Filter Chips */}
        <div className="flex justify-center mb-8 sm:mb-12 sm:px-4">
          <div className="flex flex-wrap justify-center gap-2 sm:gap-3 bg-white rounded-lg p-2 border border-gray-200 w-full sm:max-w-full">
            {[{
            id: 'competencies',
