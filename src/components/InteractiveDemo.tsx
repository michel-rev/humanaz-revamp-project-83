                ...
                <CardContent className="space-y-4">
                  <div className="flex items-center gap-3">
                    <div className={`p-2 rounded-lg bg-gradient-to-r ${
                      activeScenario === 0 ? 'from-blue-600/20 to-blue-500/20' :
                      activeScenario === 1 ? 'from-green-600/20 to-green-500/20' :
                      activeScenario === 2 ? 'from-orange-600/20 to-orange-500/20' :
                      'from-purple-600/20 to-purple-500/20'
                    }`}>
                      {React.createElement(businessScenarios[activeScenario].icon, { 
                        className: `w-6 h-6 ${
                          activeScenario === 0 ? 'text-blue-400' :
                          activeScenario === 1 ? 'text-green-400' :
                          activeScenario === 2 ? 'text-orange-400' :
                          'text-purple-400'
                        }` 
                      })}
                    </div>
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="flex flex-wrap gap-2">
                      {businessScenarios[activeScenario].evaluation.map((competence, idx) => (
                  ...
                  <div>
                    ...
                    <div className="w-full h-3 bg-slate-700 rounded-full overflow-hidden">
                      <div 
                        ...
                        style={{ width: `${businessScenarios[activeScenario].cultural_fit}%` }}
                      />
                    </div>
                  </div>
              ...
              <Card key={idx} className="bg-slate-800/50 border-slate-700 backdrop-blur-sm">
                <CardContent className="p-6">
                  ...
                  <div className="w-full h-2 bg-slate-700 rounded-full overflow-hidden mb-4">
                    <div 
                      className={`h-full transition-all duration-1000 ${
                        idx === 0 ? 'bg-gradient-to-r from-blue-500 to-blue-400' :
                        idx === 1 ? 'bg-gradient-to-r from-purple-500 to-purple-400' :
                  ...
                  <div className="space-y-2">
                    ...
                    {metric.indicators.map((indicator, indicatorIdx) => (
                      <div key={indicatorIdx} className="flex items-center gap-2 text-slate-300">
                ...
                {[
                  ...
                  <div key={idx} className="flex items-start gap-4">
                    <div className={`w-8 h-8 rounded-full flex items-center justify-center text-sm font-bold ${
                      ...
                      item.status === 'active' ? 'bg-purple-500 text-white animate-pulse' :
            ...
            <Card className="bg-slate-800/50 border-slate-700 backdrop-blur-sm">
              ...
              <CardContent className="space-y-6">
                ...
                <div className="space-y-3">
                  ...
                  {[
                    "Forte alinhamento com valores de inovação",
                    "Excelente capacidade de colaboração",
                    "Mentalidade data-driven comprovada",
                    "Experiência técnica sólida em fintech"
                  ].map((indicator, idx) => (
